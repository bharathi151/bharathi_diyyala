...
Q6="SELECT first_name || ' ' || last_name from User;"
Q7="SELECT first_name,last_name from User;"
Q8="UPDATE User SET first_name = 'thor', last_name='ragnarok'  WHERE first_name || ' ' || last_name='tony stark';"
Q9="INSERT INTO Post VALUES(2,NULL,'My Second Post');"
Q10="DELETE FROM User where first_name || ' ' || last_name='john wick';"
Q11="DROP TABLE Post;"